...
export const hostelStats = [
  { id: "stat-1", label: "TOTAL HOSTELS", value: "7", badge: "↗ Active", badgeType: "success", icon: "Building2", tone: "blue" },
  { id: "stat-2", label: "TOTAL CAPACITY", value: "176 Beds", badge: "Max Cap", badgeType: "slate", icon: "BedDouble", tone: "indigo" },
  { id: "stat-3", label: "OCCUPANCY RATE", value: "3%", badge: "Optimal", badgeType: "violet", icon: "PieChart", tone: "violet" },
  { id: "stat-4", label: "OCCUPIED BEDS", value: "6", badge: "Assigned", badgeType: "amber", icon: "UserRound", tone: "amber" },
  { id: "stat-5", label: "VACANT BEDS", value: "170", badge: "Available", badgeType: "success", icon: "BedDouble", tone: "green" },
  { id: "stat-6", label: "HOSTELLERS", value: "6", badge: "Students", badgeType: "violet", icon: "Users", tone: "violet" },
  { id: "stat-7", label: "MONTHLY REVENUE", value: "₹40,500", badge: "Billed", badgeType: "success", icon: "IndianRupee", tone: "emerald" },
  { id: "stat-8", label: "ACTIVE WARDENS", value: "4", badge: "Supervising", badgeType: "danger", icon: "ShieldCheck", tone: "rose" },
];
...
export const hostelRoomCategories = [
  {
    id: "cat-1",
...
export const hostelRooms = [
  { id: "rm-1", roomNo: "101", floor: "Floor 1", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Occupied)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-2", roomNo: "102", floor: "Floor 1", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 0, beds: ["BED-1 (Vacant)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-3", roomNo: "103", floor: "Floor 1", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 0, beds: ["BED-1 (Vacant)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-4", roomNo: "104", floor: "Floor 1", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 0, beds: ["BED-1 (Vacant)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-5", roomNo: "201", floor: "Floor 2", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 0, beds: ["BED-1 (Vacant)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-6", roomNo: "301", floor: "Floor 3", block: "BR-A", blockName: "Boys Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Occupied)", "BED-2 (Vacant)"], fee: "₹8,000/mo", status: "Active" },
  { id: "rm-7", roomNo: "102", floor: "Floor 1", block: "GR-A", blockName: "Girls Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Occupied)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-8", roomNo: "103", floor: "Floor 1", block: "GR-A", blockName: "Girls Residence - Block A", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Occupied)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
  { id: "rm-9", roomNo: "201", floor: "Floor 2", block: "BR-B", blockName: "Boys Residence - Block B", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Vacant)", "BED-2 (Occupied)"], fee: "₹7,000/mo", status: "Active" },
  { id: "rm-10", roomNo: "202", floor: "Floor 2", block: "JCW", blockName: "Junior College Wing", type: "Double Sharing", capacity: 2, occupied: 1, beds: ["BED-1 (Occupied)", "BED-2 (Vacant)"], fee: "₹5,500/mo", status: "Active" },
  { id: "rm-11", roomNo: "105", floor: "Floor 1", block: "GR-B", blockName: "Girls Residence - Block B", type: "Double Sharing", capacity: 2, occupied: 0, beds: ["BED-1 (Vacant)", "BED-2 (Vacant)"], fee: "₹6,500/mo", status: "Active" },
];

export const hostelWardens = [
  {
    id: "w-1",
    empId: "WRD-2021-01",
    name: "Dr. K. Ramesh",
    ...
    assignedHostels: "Boys Residence - Block A, Senior Wing - Block D",
    gender: "Male",
    status: "Active",
  },
  {
    ...
    assignedHostels: "Boys Residence - Block B, Junior College Wing",
    gender: "Male",
    status: "Active",
  },
  {
    ...
    assignedHostels: "Girls Residence - Block A, International Hostel - Block E",
    gender: "Female",
    status: "Active",
  },
  {
...
export const hostelAttendanceStudents = [
  { id: "ADM-2024-001", name: "Akhila Reddy", block: "HM-02", room: "Room #RM-201", bed: "BED-1", roomBed: "Room #RM-201 (BED-1)", floor: "Floor 2", gender: "Female", phone: "+91 98765 43210", parentName: "Srinivas Reddy" },
  { id: "ADM-2024-002", name: "Alexander Wright", block: "Ramachandra Bhavan (Block A)", room: "Room #108", bed: "BED-1", roomBed: "Room #108 (BED-1)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43211", parentName: "Robert Wright" },
  { id: "ADM-2024-003", name: "Alexander Wright", block: "Luxury hostel", room: "Room #001", bed: "BED-1", roomBed: "Room #001 (BED-1)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43212", parentName: "Robert Wright" },
  { id: "ADM-2024-004", name: "sample sample", block: "Luxury hostel", room: "Room #112", bed: "BED-1", roomBed: "Room #112 (BED-1)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43213", parentName: "Test Parent" },
  { id: "ADM-2024-005", name: "Arjun Naidu", block: "Luxury hostel", room: "Room #103", bed: "BED-1", roomBed: "Room #103 (BED-1)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43214", parentName: "Venkat Naidu" },
  { id: "ADM-2024-006", name: "Pooja Javadvi", block: "HM-01", room: "Room #RM-102", bed: "BED-1", roomBed: "Room #RM-102 (BED-1)", floor: "Floor 1", gender: "Female", phone: "+91 98765 43215", parentName: "Ramesh Javadvi" },
  { id: "ADM-2024-007", name: "Rahul Sharma", block: "Boys Residence - Block A", room: "Room #101", bed: "BED-1", roomBed: "Room #101 (BED-1)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43216", parentName: "Manish Sharma" },
  { id: "ADM-2024-008", name: "Sneha Reddy", block: "Girls Residence - Block A", room: "Room #102", bed: "BED-1", roomBed: "Room #102 (BED-1)", floor: "Floor 1", gender: "Female", phone: "+91 98765 43217", parentName: "Kishore Reddy" },
  { id: "ADM-2024-009", name: "Vikram Patel", block: "Boys Residence - Block B", room: "Room #201", bed: "BED-2", roomBed: "Room #201 (BED-2)", floor: "Floor 2", gender: "Male", phone: "+91 98765 43218", parentName: "Dharmesh Patel" },
  { id: "ADM-2024-010", name: "Priya Nair", block: "Girls Residence - Block A", room: "Room #103", bed: "BED-2", roomBed: "Room #103 (BED-2)", floor: "Floor 1", gender: "Female", phone: "+91 98765 43219", parentName: "Rajesh Nair" },
  { id: "ADM-2024-011", name: "Amit Kumar", block: "Boys Residence - Block A", room: "Room #301", bed: "BED-1", roomBed: "Room #301 (BED-1)", floor: "Floor 3", gender: "Male", phone: "+91 98765 43220", parentName: "Sanjay Kumar" },
  { id: "ADM-2024-012", name: "Ananya Verma", block: "Junior College Wing", room: "Room #202", bed: "BED-1", roomBed: "Room #202 (BED-1)", floor: "Floor 2", gender: "Female", phone: "+91 98765 43221", parentName: "Vikas Verma" },
  { id: "ADM-2024-013", name: "Rohan Kulkarni", block: "HM-01", room: "Room #RM-102", bed: "BED-2", roomBed: "Room #RM-102 (BED-2)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43222", parentName: "Prashant Kulkarni" },
  { id: "ADM-2024-014", name: "Divya Krishnan", block: "Girls Residence - Block A", room: "Room #108", bed: "BED-2", roomBed: "Room #108 (BED-2)", floor: "Floor 1", gender: "Female", phone: "+91 98765 43223", parentName: "Krishnan Subramanian" },
  { id: "ADM-2024-015", name: "Mohammed Farooq", block: "Boys Residence - Block B", room: "Room #201", bed: "BED-1", roomBed: "Room #201 (BED-1)", floor: "Floor 2", gender: "Male", phone: "+91 98765 43224", parentName: "Ibrahim Farooq" },
  { id: "ADM-2024-016", name: "Kavya Mehra", block: "HM-02", room: "Room #RM-201", bed: "BED-2", roomBed: "Room #RM-201 (BED-2)", floor: "Floor 2", gender: "Female", phone: "+91 98765 43225", parentName: "Sunil Mehra" },
  { id: "ADM-2024-017", name: "Siddharth Rao", block: "Ramachandra Bhavan (Block A)", room: "Room #108", bed: "BED-2", roomBed: "Room #108 (BED-2)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43226", parentName: "Anand Rao" },
  { id: "ADM-2024-018", name: "Neha Kapoor", block: "Junior College Wing", room: "Room #202", bed: "BED-2", roomBed: "Room #202 (BED-2)", floor: "Floor 2", gender: "Female", phone: "+91 98765 43227", parentName: "Praveen Kapoor" },
  { id: "ADM-2024-019", name: "Sanjay Deshmukh", block: "Boys Residence - Block A", room: "Room #101", bed: "BED-2", roomBed: "Room #101 (BED-2)", floor: "Floor 1", gender: "Male", phone: "+91 98765 43228", parentName: "Gopal Deshmukh" },
  { id: "ADM-2024-020", name: "Meera Nambiar", block: "Luxury hostel", room: "Room #112", bed: "BED-2", roomBed: "Room #112 (BED-2)", floor: "Floor 1", gender: "Female", phone: "+91 98765 43229", parentName: "Balachandran Nambiar" },
];
