export const apiEndpoints = {
  ...
  faculty: {
    ...
    sendLink: (id) => `/api/v1/staff/${id}/send-link`,
    bulkSendLinks: "/api/v1/staff/bulk-send-links",
    saveProfileDraft: (id) => `/api/v1/staff/${id}/save-profile-draft`,
    saveProfileDraftByToken: (token) => `/api/v1/staff/token/${token}/save-profile-draft`,
    submitProfile: (id) => `/api/v1/staff/${id}/submit-profile`,
    submitProfileByToken: (token) => `/api/v1/staff/token/${token}/submit-profile`,
    adminReview: (id) => `/api/v1/staff/${id}/admin-review`,
    importExcel: "/api/v1/staff/import-excel",
    exportExcel: "/api/v1/staff/export-excel",
    exportTemplate: "/api/v1/staff/export-template",
    printPdf: (id) => `/api/v1/staff/${id}/print-pdf`,
    uploadDocument: (id) => `/api/v1/staff/${id}/documents/upload`,
    uploadDocumentByToken: (token) => `/api/v1/staff/token/${token}/documents/upload`,
    deleteDocument: (id, docType) => `/api/v1/staff/${id}/documents/${encodeURIComponent(docType)}`,
    deleteDocumentByToken: (token, docType) => `/api/v1/staff/token/${token}/documents/${encodeURIComponent(docType)}`,
    uploadPhoto: "/api/v1/staff/upload-photo",
    getPhoto: (id) => `/api/v1/staff/photo/${id}`,
    lookupBloodGroups: "/api/v1/staff/lookup/blood-groups",
  ...
  fee: {
    ...
    studentFeeLedger: (studentId) => `/api/v1/fees/students/${encodeURIComponent(studentId)}/fee-ledger`,
    ...
    history: (studentId) => `/api/v1/fees/history/${encodeURIComponent(studentId)}`,
  ...
  subjects: {
    ...
    getAll: "/api/v1/subjects",
    search: "/api/v1/subjects/search",
    context: "/api/v1/subjects/context",
    getActive: "/api/v1/subjects/active",
    active: "/api/v1/subjects/active",
    getByBoard: (boardId) => `/api/v1/subjects/board/${encodeURIComponent(boardId)}`,
    byBoard: (boardId) => `/api/v1/subjects/board/${encodeURIComponent(boardId)}`,
    getByAcademicYear: (academicYearId) => `/api/v1/subjects/academic-year/${encodeURIComponent(academicYearId)}`,
    checkCode: "/api/v1/subjects/check-code",
    create: "/api/v1/subjects",
    getById: (id) => `/api/v1/subjects/${id}`,
    byId: (id) => `/api/v1/subjects/${id}`,
    update: (id) => `/api/v1/subjects/${id}`,
    delete: (id) => `/api/v1/subjects/${id}`,
    getByGroup: (groupId) => `/api/v1/subjects/group/${encodeURIComponent(groupId)}`,
    byGroup: (groupId) => `/api/v1/subjects/group/${encodeURIComponent(groupId)}`,
  },
  departments: {
  ...
  attendance: {
    ...
    studentDefaulters: "/api/v1/attendance/defaulters",
    ...
    studentMonthlyExportExcel: "/api/v1/attendance/student-monthly-report/export/excel",
  ...
  staffAttendance: {
    ...
    update: "/api/v1/staff-attendance/update",
  ...
  students: {
    ...
    importTemplate: "/api/v1/students/import/template",
    importValidate: "/api/v1/students/import/validate",
    importExcel: "/api/v1/students/import/excel",
    importCredentialsPdf: "/api/v1/students/import/credentials-pdf",
    uploadPhoto: (studentId) => `/api/v1/students/${encodeURIComponent(studentId)}/photo`,
    uploadDocuments: (studentId) => `/api/v1/students/${encodeURIComponent(studentId)}/documents`,
  },
  academicLevels: {
  ...
  promotions: {
    ...
    groupAllocation: "/api/v1/promotions/group-allocation",
    programAllocation: "/api/v1/promotions/program-allocation",
    sectionAllocation: "/api/v1/promotions/section-allocation",
    history: "/api/v1/promotions/history",
  ...
  transport: {
    ...
    routeById: (id) => `/api/v1/transport/routes/${id}`,
    pickupPoints: "/api/v1/transport/pickup-points",
    pickupPointById: (id) => `/api/v1/transport/pickup-points/${id}`,
    vehicles: "/api/v1/transport/vehicles",
    vehicleById: (id) => `/api/v1/transport/vehicles/${id}`,
    drivers: "/api/v1/transport/drivers",
    driverById: (id) => `/api/v1/transport/drivers/${id}`,
    attendants: "/api/v1/transport/attendants",
    attendantById: (id) => `/api/v1/transport/attendants/${id}`,
    vehicleAssignments: "/api/v1/transport/vehicle-assignments",
    vehicleAssignmentById: (id) => `/api/v1/transport/vehicle-assignments/${id}`,
    trips: "/api/v1/transport/operations/trips",
    tripById: (id) => `/api/v1/transport/operations/trips/${id}`,
    gps: "/api/v1/transport/operations/gps",
    maintenance: "/api/v1/transport/maintenance",
    maintenanceById: (id) => `/api/v1/transport/maintenance/${id}`,
    studentAssignments: "/api/v1/transport/student-assignments",
    studentAssignmentById: (id) => `/api/v1/transport/student-assignments/${id}`,
    ...
    dashboardReport: "/api/v1/transport/reports/dashboard",
    tripReports: "/api/v1/transport/reports/trips",
    vehicleReports: "/api/v1/transport/reports/vehicles",
    driverReports: "/api/v1/transport/reports/drivers",
