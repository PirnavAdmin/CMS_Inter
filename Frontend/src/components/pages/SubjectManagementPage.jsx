...
export default function SubjectManagementPage() {
  ...
  const { selectedCampusId: navbarCampusId } = useCampusContext();
  ...
  useEffect(() => {
    ...
    return () => { active = false; };
  }, [navbarCampusId, navbarBoardId, navbarAcademicYearId]);
  useEffect(() => {
    let active = true;
