...
namespace CollegeManagement.API.Migrations
{
    ...
    [Migration("20260922122627_AddDriverPortalEntities")]
    partial class AddDriverPortalEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.Staff.Staff", b =>
                {
                    ...
                    b.Property<DateTime?>("ProfileLinkExpiresAt")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("ProfileLinkSentAt")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("ProfileLinkToken")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.StaffLeaveBalance", b =>
                {
                    ...
                    b.ToTable("StaffLeaveBalances", (string)null);
                });
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.StudentAdmission", b =>
                {
                    ...
                    b.Property<string>("StreetVillage")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.Timetable.TimetableSubstitution", b =>
                {
                    ...
                    b.Property<int>("OriginalStaffId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SubstituteStaffId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CollegeManagement.API.Models.Timetable.TimetableSubstitution", b =>
                {
                    b.HasOne("CollegeManagement.API.Models.Staff.Staff", "OriginalStaff")
                        .WithMany()
                        .HasForeignKey("OriginalStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("CollegeManagement.API.Models.StaffLeaveRequest", "StaffLeaveRequest")
                        .WithMany()
                        .HasForeignKey("StaffLeaveRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_TimetableSubstitutions_LeaveRequest");

                    b.HasOne("CollegeManagement.API.Models.Staff.Staff", "SubstituteStaff")
                        .WithMany()
                        .HasForeignKey("SubstituteStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_TimetableSubstitutions_SubStaff");

                    b.HasOne("CollegeManagement.API.Models.Timetable.Timetable", "Timetable")
                        .WithMany()
                    ...
                    b.Navigation("OriginalStaff");

                    b.Navigation("Period");

                    b.Navigation("Section");

                    b.Navigation("StaffLeaveRequest");
